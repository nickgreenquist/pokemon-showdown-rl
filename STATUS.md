...
- **SEEDS DO NOT PAIR BATTLES (`docs/landmines.md`).** Agreement on shared seeds is at the independence
  level (0.66–0.73) — every "matched seed-for-seed, McNemar se" phrase was UNPAIRED. Replicates are the instrument.
