...
- **SUITE GREEN 1044 / 0 failed, 96 skipped** (2026-09-16, encoder flags UNSET — the documented
  invocation). The R5 audit found TWO tests RED at bb1a0dc and fixed both: the committed-docs W-L
  guard never learned R5's pairs (and its line regex stopped at `R[134]`), and the 100M seed-window
  gate named the monster fleet's PLANNED dirs, so it went red the day the fleet launched. Engine 115 + 94 cargo.
