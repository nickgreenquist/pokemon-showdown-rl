...
- **Anchor battery (2026-08-23 ruling):** every headline-grade result reports vs-SH (locked protocol, the credit line) PLUS the two descriptive anchors — BC-clone h2h (500 battles) and Foul Play h2h (250, "FP + our patches") — before its README row lands. Anchors are descriptive columns, never verdict inputs (n too small to credit).
