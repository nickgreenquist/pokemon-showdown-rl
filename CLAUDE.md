...
- **Anchor battery (2026-08-23 ruling):** every headline-grade result reports vs-SH (locked protocol, the credit line) PLUS the two descriptive anchors — BC-clone h2h (500 battles) and Foul Play h2h (250 at --search-time-ms 100, "FP + our patches") — before its README row lands. Anchors are descriptive columns, never verdict inputs (n too small to credit). The **FP budget ladder** (FP@20 / FP@100 / FP@500, `configs/eval/fp_budget_ladder.yaml`) is the readiness gradient: once a model beats FP@100, it faces FP@500.
