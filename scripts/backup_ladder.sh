...
RUNS=("L2:replays" "R3S:replays_r3" "R4G:replays_r4" "R5E:replays_r5")   # BI-R4-1 (ladder_r4): without this the OK line says nothing about R4; R5E added 2026-09-16 before its mid-run backup
fail=0
