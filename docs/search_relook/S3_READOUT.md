...
**MACHINE-WRITTEN by `scripts/search_s3_readout.py` at 2026-09-10T17:32:31+00:00.** Regenerated in place on every run — do not hand-edit; edit the script.
...
Pre-regs: `configs/eval/search_s3_100m.yaml` (sha256 `30d224b1048f89cb…`) · `configs/eval/search_s3_100m_offfp.yaml` (sha256 `9c82af2080aa7f48…`) · P-B's read: `docs/search_relook/DET_BLIND.md` §6 (P-B's read, verbatim). git HEAD `1212e81c5c67` (dirty: True).
...
| S3M | depth-1 search, dose M (n_det 4, top_branches 6, leaf_cap 1296), as-is leaf encoding | s104/s112/s120 | 23/30 | 6900 | 0.71942 *(PARTIAL)* | PARTIAL |
| S3B | S3M with leaf_encoding: det_blind (DET_BLIND.md) | s104/s112/s120 | 6/30 | 1800 | 0.70444 *(PARTIAL)* | PARTIAL |
...
| S3M | 0.72286 PARTIAL (7/10) | 0.74458 PARTIAL (8/10) | 0.69125 PARTIAL (8/10) |
| S3B | 0.72500 PARTIAL (2/10) | 0.71000 PARTIAL (2/10) | 0.67833 PARTIAL (2/10) |
...
> PENDING — NO CELL ON PARTIAL DATA. Incomplete jobs: s3m_s104 7/10, s3m_s112 8/10, s3m_s120 8/10. The per-lane numbers above are running pooled rates over completed chunks (PARTIAL); they are printed so the run is readable as a RATE, and they are NEVER cell inputs.

| lane | S3M (partial) | A0 (partial) |
| --- | ---: | ---: |
| s104 | 0.72286 (7/10) | 0.78933 (10/10) |
| s112 | 0.74458 (8/10) | 0.78233 (10/10) |
| s120 | 0.69125 (8/10) | 0.79433 (10/10) |
...
> PENDING — NO CELL ON PARTIAL DATA. Incomplete jobs: s3b_s104 2/10, s3b_s112 2/10, s3b_s120 2/10, s3m_s104 7/10, s3m_s112 8/10, s3m_s120 8/10. The per-lane numbers above are running pooled rates over completed chunks (PARTIAL); they are printed so the run is readable as a RATE, and they are NEVER cell inputs.

| lane | S3B (partial) | S3M (partial) |
| --- | ---: | ---: |
| s104 | 0.72500 (2/10) | 0.72286 (7/10) |
| s112 | 0.71000 (2/10) | 0.74458 (8/10) |
| s120 | 0.67833 (2/10) | 0.69125 (8/10) |
...
> PENDING — NO CELL ON PARTIAL DATA. Incomplete jobs: s3b_s104 2/10, s3b_s112 2/10, s3b_s120 2/10. The per-lane numbers above are running pooled rates over completed chunks (PARTIAL); they are printed so the run is readable as a RATE, and they are NEVER cell inputs.

| lane | S3B (partial) | A0 (partial) |
| --- | ---: | ---: |
| s104 | 0.72500 (2/10) | 0.78933 (10/10) |
| s112 | 0.71000 (2/10) | 0.78233 (10/10) |
| s120 | 0.67833 (2/10) | 0.79433 (10/10) |
...
> PENDING — NO CELL ON PARTIAL DATA. Incomplete jobs: a1e_s104 0/10, a1e_s112 0/10, a1e_s120 0/10, s3m_s104 7/10, s3m_s112 8/10, s3m_s120 8/10. The per-lane numbers above are running pooled rates over completed chunks (PARTIAL); they are printed so the run is readable as a RATE, and they are NEVER cell inputs.

| lane | A1E (partial) | S3M (partial) |
| --- | ---: | ---: |
| s104 | — (0/10) | 0.72286 (7/10) |
| s112 | — (0/10) | 0.74458 (8/10) |
| s120 | — (0/10) | 0.69125 (8/10) |
...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| A0 | — | — | — | — | — | — | — | COMPLETE |
| S3M | M | as_is | 61.8 | 276.0 | 369851 | 0.7339 | 0.0267 | PARTIAL |
| S3B | M | det_blind | 59.3 | 280.8 | 93669 | 0.7291 | 0.0238 | PARTIAL |
...
> S3B 280.76 vs S3M 276.02 — relative delta +0.0172 within the stated +-5% tolerance; computed over COMPLETED CHUNKS ONLY (PARTIAL). (PASS; diagnostic, no cell.)
...
> flip-rate delta (S3B − S3M) = -0.0048 (S3B 0.7291 on basis PARTIAL, S3M 0.7339 on basis PARTIAL).
...
| F3B112 | det_blind | — | — | — | — | — | PENDING — no final on disk (runner log present — arm is running) |

> PENDING — both off-FP arms must be complete before the B-vs-M comparison prints.
