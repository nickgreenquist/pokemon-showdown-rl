...
- I did **not** open `FP` (foul-play), `PSPPO`, `MG` (metagrok), `PW/pokejax`, `docs/prior_work/README.md`, or any of the four PDF text dumps. Nothing in this note is sourced from them, and the Metamon/Wang/H&L cross-checks belong to other agents.
